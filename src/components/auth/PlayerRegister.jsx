// src/components/auth/PlayerRegister.jsx
import { useState } from 'react';
import { Form, Input, Button, Alert } from '../common';

function PlayerRegister({ onSubmit, loading, error, onBack }) {
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Create Player Account</h2>
        <p className="text-gray-600">
          Join our community to discover facilities and connect with other players
        </p>
      </div>
        ...
        <div className="mb-6">
          <label className="flex items-start">
            ...
            <span className="text-sm text-gray-600">
              I confirm I am 16+ and accept that football involves risk, and I agree to the{' '}
